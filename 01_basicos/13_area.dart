...
main(){
  ...
  String? b = 'S';
  print('calculador de areas o volumenes (en metros)');
  while( b == 'S'){
    stdout.write('¿Que desea calcular?(elija "area" o "volumen") ');
    ...
    if(a == 'area'){
      ...
      print('2. Triangulo');
      print('3. Rectangulo');
      stdout.write('Selecciona una figura: ');
      String? figura = stdin.readLineSync()?.toLowerCase();
      switch(figura){
        case 'circulo':
        case '1':
          stdout.write('Ingresa el radio: ');
        ...
        case 'triangulo':
        case '2':
          stdout.write('Ingresa la altura: ');
    ...
    if(a == 'volumen'){
      ...
      switch(figura){
        ...
        case '2':
          stdout.write('Ingresa la altura: ');
          double altura = double.parse(stdin.readLineSync()!);
          stdout.write('Ingresa el area de la base: ');
        ...
        case 'cubo':
        case '3':
          stdout.write('Ingresa la medida de un lado: ');
